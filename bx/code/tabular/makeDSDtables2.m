...
for sCount = 1:length(subject_numbers)
    ...
    thisTable = table(subID,sess,tnum,tcond,pickTarget,dumpTarget,pickCoin,dumpCoin,pickValue,dumpValue,discoResponse,choiceOnset,choiceRT,discoOnset,discoRT);
